...
<div id="mySidenav" class="sidenav f-ply">
      ...
      <div class="text-light">
          ...
          <h6 class="pt-1 pl-4 text-white"><?php echo $_SESSION['mob']?></h6>
      </div><!--------profile close--------->
      <!-------- Account Menus open--------->
      <ul class="nav nav-tabs flex-column text-dark side-mu">
          ...
          <li class="nav-item">
             <a class="nav-link py-3" href="contacts.php"><img src="assets/images/contacts.png" style="width:25px;height:25px">&nbsp;&nbsp; Contacts</a>
          </li>
          <li class="nav-item">
  ...
  <br class="d-block d-md-none">
<div class="container-fluid px-1 py-0 mt-3 d-block d-md-none">
  <div class="card py-2 mt-1 sd">
    <div class="row m-0">
...
<!---------------------------------lg screen start-------------------->
<div class="container d-none d-md-block sd" style="height: 100vh">
  <div class="row h-100">
    <div class="col-md-4 pt-5 p-2 bg-white msg_list border-right" style="max-height: 100%;overflow-y: auto;">
      <br>
       <div class="card py-2 mt-1 sd">
        <div class="row m-0">
          <div class="col-3 d-flex align-items-center justify-content-center">
            <img src="assets/images/pro.jpg" class="rounded-circle" style="width:50px;height: 50px">
          </div>
          <div class="col-9 p-0 px-1">
            <p class="mb-0"><b>Daily Updates</b></p>
            <p class="text-muted mb-1 text-truncate">you:photo</p>
          </div>
        </div>
    ...
    <div class="col-md-8 pt-5 bg-white p-3" style="background:linear-gradient(rgba(225,225,225,.1), rgba(225,225,225,.1)),url(assets/images/bg14.jpg)">
      <br>
      t
    </div>
  </div>
